			...
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">Input Dokument</h4>
					</header><!-- .widget-header -->
					<hr class="widget-separator">
					<div class="widget-body">
						
						<form method="POST" action="<?=base_url('Dokument_tos/simpan')?>" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="file" class="form-control" id="file" placeholder="File" name="userfile" accept="application/pdf">
							</div>
							<div class="form-group">
								<label for="judul_video">Judul Dokument</label>
								<input type="judul_video" class="form-control" id="judul_dokument" placeholder="Judul Dokumen" name="judul_dokument">
							</div>
							<div class="form-group">
