			...
			<div class="col-md-12">
				<div class="widget">
					...
					<div class="widget-body">
						...
						<form method="POST" enctype="multipart/form-data" action="<?= base_url('Pengajar_tos/simpan')?>">
							<div class="form-group">
								<label for="nama">Nama</label>
								<input type="text" class="form-control" id="nama" placeholder="Nama" name="nama_pengajar">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="sex" placeholder="Jenis Kelamin" name="sex">
							</div>
