			...
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">Input Video</h4>
					</header><!-- .widget-header -->
					<hr class="widget-separator">
					<div class="widget-body">
						
						<form method="POST" action="<?=base_url('Video_tos/simpan')?>" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="file" class="form-control" id="file" placeholder="File" name="userfile" accept="video/mp4">
							</div>
							<div class="form-group">
								<label for="judul_video">Judul Video</label>
								<input type="judul_video" class="form-control" id="judul_video" placeholder="Judul Video" name="judul_video">
							</div>
							<div class="form-group">
