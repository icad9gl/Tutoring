				...
				<div class="col-md-12">
					<div class="widget">
						<header class="widget-header">
							<h4 class="widget-title">Data Dokument</h4>
							<br>
								<a href="<?= base_url('index.php/Dokument_tos/add_form')?>">
