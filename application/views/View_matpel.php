				...
				<div class="col-md-12">
					<div class="widget">
						<header class="widget-header">
							...
							<br>
								<a href="<?= base_url('index.php/Matpel_tos/add_form')?>">
					...
					<div class="widget-body">
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped" cellspacing="0" width="100%">
								...
								<tbody>
									<?php foreach ($List_matpel as $data): ?>
									<tr>
										<td><?=  str_pad($data->id_matapelajaran,6,"0", STR_PAD_RIGHT) ?></td>
										<td><?=$data->nama_matapelajaran ?></td>
										<td>
											<a href="<?= base_url('index.php/Matpel_tos/edit_form/'.$data->id_matapelajaran) ?>" > 
											<img src="<?= base_url() ?>/assets/icon/edit.png" style="width: 23px; height: 23px;" data-toggle="tooltip" title="Edit Data">
											</a>
											<a href="<?= base_url('index.php/Matpel_tos/delete/'.$data->id_matapelajaran) ?>">
